...
> 初始化 Harness 时必须先填写本节。未填写前，AI 不应把下面的技术栈占位项当作项目事实。
...
- 本项目固定使用：
  ...
  - 语言：`<请填写真实语言和版本>`
- 禁止生成：
  - `<例如：React 组件 / Vue SFC / JSX / Ant Design / Element Plus / Redux / Pinia>`
- 与模板不同的地方：
  - `<请填写>`
...
- [ ] 本文档中的项目名称、技术栈、启动命令来自真实项目
- [ ] 本文档中的启动命令已验证可运行
- [ ] 本文档中的依赖、环境变量、部署信息与当前仓库一致
- [ ] 本文档中的禁止技术栈已经明确写出
- [ ] 本文档最后校验日期已更新
