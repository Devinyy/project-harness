# EXAMPLE_COMPONENT_PATTERN_REACT.md

> 本示例只用于 React + TypeScript + TSX 项目。
> 如果当前项目不是 React 技术栈，请不要引用本示例生成代码。
...
> 实际项目中如使用 TanStack Query / SWR / Redux / Zustand 等，请替换为对应的请求管理方式，
