...
| `docs/examples/react/EXAMPLE_COMPONENT_PATTERN_REACT.md` 或 `docs/examples/vue/EXAMPLE_COMPONENT_PATTERN_VUE.md` | 按当前项目技术栈选择参考示例 | 推荐 |
...
- 按当前项目技术栈参考 `docs/examples/react/` 或 `docs/examples/vue/` 中的组件示例
